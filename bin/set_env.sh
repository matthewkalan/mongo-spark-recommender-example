...
export SPARK_HOME="/dev/spark-1.6.1-bin-hadoop2.6"
export MAIN_JAR_HOME="/github/mongo-spark-recommender-example/target/reco-engine-example-1.0.0.jar"
...
export MONGODB_INPUT_CONN_STRING=mongodb://localhost:27017/movielens.ratings
